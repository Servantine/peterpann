          ...
          <div class="left-side-menu">
               ...
               <div id="sidebar-menu">
                    ...
                    <ul class="metismenu" id="side-menu">
                         ...
                         <li class="">
                              <a href="../Dosen/laporan.php" class="active-class active-txt">
                                   ...
                                   <div class="row">
                                        <div class="col-12">
                                             ...
                                             <div class="card-container">
                                                  ...
                                                  $sql = "SELECT laporan_kegiatan.*, rencana_kegiatan.judul_kegiatan FROM rencana_kegiatan JOIN laporan_kegiatan ON rencana_kegiatan.id_rencana_kegiatan = laporan_kegiatan.id_rencana_kegiatan JOIN kelompok_kkn ON laporan_kegiatan.id_kelompok = kelompok_kkn.id_kelompok WHERE kelompok_kkn.id_kelompok = '" . $_GET['details'] . "'";
                                                                 ...
                                                                 <tbody>
                                                                      ...
                                                                      if ($result->num_rows > 0) {
                                                                           while ($row = $result->fetch_assoc()) {
                                                                                ...
                                                                                echo '<td> <a href="laporan.php?details=' . $row['id_kelompok'] . '" class="stretched-link">' . $row['nama_kelompok'] . '</td>';
                                                                                echo '<td>' . $row['kode'] . '</td>';

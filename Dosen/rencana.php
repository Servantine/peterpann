                              ...
                              <div class="row">
                                   <div class="col-12">
                                        ...
                                        <div class="card-container">
                                             ...
                                             $sql = "SELECT rencana_kegiatan.* FROM rencana_kegiatan JOIN kelompok_kkn ON rencana_kegiatan.id_kelompok = kelompok_kkn.id_kelompok WHERE kelompok_kkn.nidn = '$nidn_pengguna'";

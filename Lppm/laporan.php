          ...
          <div class="left-side-menu">
               ...
               <div id="sidebar-menu">
                    ...
                    <ul class="metismenu" id="side-menu">
                         ...
                         <li class="">
                              <a href="../Lppm/laporan.php" class="active-class active-txt">
                                   ...
                                   <div class="col-12">
                                        ...
                                        <div class="card-container">
                                             ...
                                             if (isset($_GET["id"])) {
                                                  ...
                                                  $sql = "SELECT laporan_kegiatan.*, rencana_kegiatan.judul_kegiatan FROM rencana_kegiatan JOIN laporan_kegiatan ON rencana_kegiatan.id_rencana_kegiatan = laporan_kegiatan.id_rencana_kegiatan JOIN kelompok_kkn ON laporan_kegiatan.id_kelompok = kelompok_kkn.id_kelompok WHERE kelompok_kkn.id_kelompok = '" . $id_kelompok . "'";
                                        ...
                                        <a href="./laporan.php" class="btn btn-info btn-lg"> Kembali </a>
                                   </div>
                                   <?php
                                   // Menutup koneksi
                                   $conn->close();
                                        ...
                                        <div class="col-12">
                                             ...
                                             <table class="table table-hover">
                                                  ...
                                                  <tbody>
                                                       ...
                                                       $sql = "SELECT kelompok_kkn.id_kelompok, kelompok_kkn.nama_kelompok, kelompok_kkn.lokasi, kkn.kode, kkn.nama_kkn, kkn.tema FROM kelompok_kkn INNER JOIN kkn ON kelompok_kkn.id_kkn = kkn.id_kkn;";
                                                       ...
                                                       if ($result->num_rows > 0) {
                                                            while ($row = $result->fetch_assoc()) {
                                                                 ...
                                                                 echo '<td><a href="./laporan.php?id=' . $row['id_kelompok'] . '" class="stretched-link">' . $row['nama_kelompok'] . '</td>';
                                                                 echo '<td>' . $row['kode'] . '</td>';
